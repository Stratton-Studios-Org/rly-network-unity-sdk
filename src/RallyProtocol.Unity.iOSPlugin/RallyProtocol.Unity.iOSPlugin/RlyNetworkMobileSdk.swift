...
public class RlyNetworkMobileSdk: NSObject {
    ...
    @objc public func getBundleId() -> String {
        return Bundle.main.bundleIdentifier!
    }
    
    @objc public func getMnemonic() -> String? {
    ...
    @objc public func generateMnemonic() -> String {
    ...
    @objc public func mnemonicBackedUpToCloud() -> Bool {
    ...
    @objc public func deleteMnemonic() -> Bool {
